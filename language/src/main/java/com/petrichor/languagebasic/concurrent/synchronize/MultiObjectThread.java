package com.petrichor.languagebasic.concurrent.synchronize;
...
public class MultiObjectThread {
    ...
    private synchronized void printNum(String tag) { // 加了static就是类锁了
//    private static synchronized void printNum(String tag) { // 加了static就是类锁了
        try {
            if (tag.equals("a")) {
                num = 100;
